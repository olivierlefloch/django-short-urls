...
def response(message=None, status_code=HTTP_OK, **kwargs):
    kwargs.update({
        "status_code": status_code,
        "error": status_code != HTTP_OK,
        "message": message
    })

    return HttpResponse(json.dumps(kwargs), status=status_code, mimetype="application/json")
